...
import 'package:humidity_app_slider/utils.dart';
...
class HumidityControllerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final labelValueStyle = ui.TextStyle(color: Colors.purple,fontSize: 60, fontWeight: FontWeight.bold);
    ...
    for (var i = 0; i <= labelCount; i++) {
      ...
      final textStyle = ui.TextStyle(color: Colors.white, fontSize:20, fontWeight: FontWeight.bold);
